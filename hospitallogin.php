...
<h1 style="color:#fff;text-align:center;margin-top:100px">Hospital's Login</h1>

<form class="regform" action="hospital_login.php" method="post">
<label for="hospemail">Username:</label>
<input class="inp" type="email" name="hospemail" placeholder="username@gmail.com" required>
<br>
